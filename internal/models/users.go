...
// Authenticate retrieves the id and hashed password associated with the given
// email. If no matching email exists we return the ErrInvalidCredentials error.
